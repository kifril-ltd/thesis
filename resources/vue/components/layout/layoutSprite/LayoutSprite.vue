<template>
  <svg display="none" xmlns="http://www.w3.org/2000/svg">
    <symbol id="background-icon" viewBox="0 0 64 64">
      <defs id="defs4">
        ...
        <linearGradient
          ...
          x2="8"
          gradientTransform="matrix(1 0 0 .66667 39 15.333)"
          y1="44.5"
          x1="17"
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
          x2="11"
          gradientTransform="matrix(-1 0 0 -.66667 64 75.667)"
          y1="34"
          x1="8"
          inkscape:collect="always"
        />
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
          x2="17"
          gradientTransform="matrix(-1 0 0 -1.2381 51 95.095)"
          y1="34"
          x1="6"
          inkscape:collect="always"
        />
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
          x2="8"
          gradientTransform="matrix(1 0 0 1.2381 26 -20.095)"
          y1="44.5"
          x1="19"
          inkscape:collect="always"
        />
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
          x2="17"
          gradientTransform="matrix(-1 0 0 -1.7143 38 111.29)"
          y1="34"
          x1="8"
          inkscape:collect="always"
        />
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
          x2="8"
          gradientTransform="matrix(1 0 0 1.5238 13 -42.81)"
          y1="44.5"
          x1="17"
          inkscape:collect="always"
        />
      ...
      <g id="layer1" inkscape:label="Calque 1" inkscape:groupmode="layer">
        ...
        <path
          ...
          style="fill: #204a87"
          d="m6 29.867s0-1.867 1.8571-1.867h9.2859c1.857 0 1.857 1.867 1.857 1.867v23.133h-13v-23.133z"
        />
        <path
          id="rect3240"
          sodipodi:nodetypes="csssccs"
          style="fill: #cc0000"
          d="m45 38.067s0-1.867 1.857-1.867h9.286c1.857 0 1.857 1.867 1.857 1.867v14.933h-13v-14.933z"
        />
        <path
          id="path2428"
          sodipodi:nodetypes="csssccs"
          style="fill: #4e9a06"
          d="m19 8.8667s0-1.8667 1.857-1.8667h9.286c1.857 0 1.857 1.8667 1.857 1.8667v44.133h-13v-44.133z"
        />
        <path id="rect3242" style="fill: url(#linearGradient2516)" d="m21 9h9v44h-9v-44z" />
        <path
          id="path2426"
          sodipodi:nodetypes="csssccs"
          style="fill: #f57900"
          d="m32 21.867s0-1.867 1.857-1.867h9.286c1.857 0 1.857 1.867 1.857 1.867v31.133h-13v-31.133z"
        />
        <path id="rect3244" style="fill: #fcaf3e" d="m34 22h9v31h-9v-31z" />
        <path id="rect3246" style="fill: url(#linearGradient2511)" d="m47 38h9v15h-9v-15z" />
        <path id="rect3250" style="fill: url(#linearGradient2508)" d="m8 30h9v23h-9v-23z" />
        <path
          id="rect3252"
          style="fill: #555753"
          d="m3 53h58c0.554 0 1 0.446 1 1s-0.446 1-1 1h-58c-0.554 0-1-0.446-1-1s0.446-1 1-1z"
        />
        <path id="path2432" style="fill: url(#linearGradient2504)" d="m34 22h9v31h-9v-31z" />
        <path
          id="path3584"
          style="fill: url(#linearGradient2501)"
          d="m8 30v3.312c0.1887-0.05 0.3833-0.083 0.5938-0.062 0.8251 0.118 1.4672 0.717 1.9682 1.344 0.741 1.028 1.539 2.01 2.438 2.906 1.165 1.186 2.505 2.257 4 3v-10.5h-9z"
        />
        <path
          id="path3600"
          style="fill: url(#linearGradient2498)"
          d="m17 53v-3.312c-0.189 0.05-0.383 0.083-0.594 0.062-0.825-0.118-1.467-0.717-1.968-1.344-0.741-1.028-1.539-2.01-2.438-2.906-1.165-1.186-2.5047-2.257-4-3v10.5h9z"
        />
        <path
          id="path3624"
          style="fill: url(#linearGradient2495)"
          d="m21 9v5.048c0.189-0.077 0.383-0.128 0.594-0.096 0.825 0.181 1.467 1.093 1.968 2.048 0.741 1.567 1.539 3.063 2.438 4.429 1.165 1.808 2.505 3.438 4 4.571v-16h-9z"
        />
        <path
          id="path3662"
          style="fill: url(#linearGradient2492)"
          d="m30 53v-5.679c-0.189 0.087-0.383 0.144-0.594 0.108-0.825-0.203-1.467-1.23-1.968-2.304-0.741-1.763-1.539-3.446-2.438-4.982-1.165-2.034-2.505-3.869-4-5.143v18h9z"
        />
        <path
          id="path3666"
          style="fill: url(#linearGradient2489)"
          d="m34 22v4.101c0.189-0.062 0.383-0.104 0.594-0.077 0.825 0.146 1.467 0.888 1.968 1.664 0.741 1.273 1.539 2.488 2.438 3.598 1.165 1.469 2.505 2.794 4 3.714v-13h-9z"
        />
        <path
          id="path3670"
          style="fill: url(#linearGradient2486)"
          d="m43 53v-4.101c-0.189 0.062-0.383 0.104-0.594 0.077-0.825-0.146-1.467-0.888-1.968-1.664-0.741-1.273-1.539-2.488-2.438-3.598-1.165-1.469-2.505-2.794-4-3.714v13h9z"
        />
        <path
          id="path3674"
          style="fill: url(#linearGradient2483)"
          d="m56 53v-2.208c-0.189 0.033-0.383 0.056-0.594 0.041-0.825-0.079-1.467-0.478-1.968-0.895-0.741-0.686-1.539-1.34-2.438-1.938-1.165-0.791-2.505-1.504-4-2v7h9z"
        />
        <path
          id="path3678"
          style="fill: url(#linearGradient2480)"
          d="m47 38v2.208c0.189-0.033 0.383-0.056 0.594-0.041 0.825 0.079 1.467 0.478 1.968 0.895 0.741 0.686 1.539 1.34 2.438 1.938 1.165 0.791 2.505 1.504 4 2v-7h-9z"
        />
      </g>
    </symbol>
    ...
    <symbol id="x-mark" viewBox="0 0 16 16">
      <path
    ...
    <symbol id="user_management" viewBox="0 0 16 16">
    ...
    <symbol id="rights_management" viewBox="0 0 16 16">
      <path
        d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"
      />
    </symbol>
    <symbol id="archiving_management" viewBox="0 0 16 16">
      <path
    ...
    <symbol id="plusRow" viewBox="0 0 16 16">
      <path
    ...
    <symbol id="drag_drop" viewBox="0 0 320 512">
      <path
    ...
    <symbol id="upper-arrow" viewBox="0 0 16 16">
      <path
    ...
    <symbol id="attribute_management" viewBox="0 0 640 512">
      <path
    ...
    <symbol id="minusRow" viewBox="0 0 16 16">
      <path
