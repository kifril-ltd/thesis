<template>
  <energy-modal ref="modal">
    ...
    <div class="modal-footer">
      <button type="button" @click="closeFilterModal" class="btn btn-danger closebtn">Закрыть</button>
      <button type="button" @click="addNewObjectToDB" class="btn btn-success savebtn">Сохранить изменения</button>
    </div>
  </energy-modal>
</template>

<script>
import { EnergyIcon, EnergyButton, EnergyModal } from '@/ui';
...
export default {
  ...
  methods: {
    ...
    async addNewObjectToDB(dataFromCard) {
      const data = dataFromCard;
      // await TableApi.createRow(this.tableId, data);
