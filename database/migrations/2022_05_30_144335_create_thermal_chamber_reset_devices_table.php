...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('thermal_chamber_reset_devices', function (Blueprint $table) {
            $table->uuid('thermal_chamber_reset_device_id');
            ...
            $table->primary('thermal_chamber_reset_device_id');
    ...
    {
        Schema::dropIfExists('thermal_chamber_reset_devices');
    }
};
