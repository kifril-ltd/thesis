...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('boiler_room_accidents', function (Blueprint $table) {
            $table->uuid('boiler_room_accident_id');
            ...
            $table->primary('boiler_room_accident_id');
    ...
    {
        Schema::dropIfExists('boiler_room_accidents');
    }
};
