...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('pumping_station_heat_exchangers', function (Blueprint $table) {
            $table->uuid('pumping_station_heat_exchanger_id');
            ...
            $table->primary('pumping_station_heat_exchanger_id');
    ...
    {
        Schema::dropIfExists('pumping_station_heat_exchangers');
    }
};
