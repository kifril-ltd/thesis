...
class BoilerRoomEquipmentMetaColumnSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $boilerRoomEquipmentMetaObjectId = MetaObject::where('name', 'meta_boiler_room_equipments')->first()->meta_object_id;
        $namePrefix = 'meta_boiler_room_equipment_';

        $boiler_room_equipment_attrs = [
            [
                'entity_col_id' => Str::Uuid()->toString(),
                'meta_obj_dataset_id' => $boilerRoomEquipmentMetaObjectId,
                'meta_obj_id' => MetaObject::where('name', $namePrefix . 'boiler_room_equipment_id')->first()->meta_object_id,
                'data_type' => 'uuid',
                'metric' => null,
                'is_basic' => true,
                'is_required' => true,
        ...
        EntityCol::insert($boiler_room_equipment_attrs);
    }
}
