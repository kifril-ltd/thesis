...
class HeatingNetworkAccidentMetaObjectColumnSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $heating_network_accident_attrs = [
            [
                'meta_object_id' => Str::Uuid()->toString(),
            ...
            [
                'meta_object_id' => Str::Uuid()->toString(),
                'object' => 'address',
                'caption' => 'Адрес места аварии',
                'desc' => 'Адрес места аварии',
            ],
            [
                'meta_object_id' => Str::Uuid()->toString(),
                'object' => 'mode',
        ...
        array_push($heating_network_accident_attrs, ...$commonAttrs);

        foreach ($heating_network_accident_attrs as &$attr) {
            $attr['meta_module_id'] = $thermalModuleId;
            $attr['meta_kind_id'] = $columnKindId;
            $attr['name'] = 'meta_' . 'heating_network_accident_' . $attr['object'];
            $attr['class_name'] = HeatingNetworkAccident::class;
        }

        MetaObject::insert($heating_network_accident_attrs);
    }
}
