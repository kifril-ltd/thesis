...
class PumpingStationAccidentMetaObjectColumnSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $pumping_station_accident_attrs = [
            [
                'meta_object_id' => Str::Uuid()->toString(),
                'object' => 'pumping_station_accident_id',
        ...
        array_push($pumping_station_accident_attrs, ...$commonAttrs);

        foreach ($pumping_station_accident_attrs as &$attr) {
            $attr['meta_module_id'] = $thermalModuleId;
            $attr['meta_kind_id'] = $columnKindId;
            $attr['name'] = 'meta_' . 'pumping_station_accident_' . $attr['object'];
            $attr['class_name'] = PumpingStationAccident::class;
        }

        MetaObject::insert($pumping_station_accident_attrs);
    }
}
