...
class BoilerRoomExpenditureMetaObjectColumnSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $boiler_room_expenditures_attrs = [
            [
                'meta_object_id' => Str::Uuid()->toString(),
                'object' => 'boiler_room_expenditure_id',
                'caption' => 'Идентификатор расхода котельной',
                'desc' => 'Идентификатор расхода котельной',
            ],
            [
                'meta_object_id' => Str::Uuid()->toString(),
            ...
            [
                'meta_object_id' => Str::Uuid()->toString(),
                'object' => 'purchase_of_gas',
                'caption' => 'Затраты на покупку газа',
                'desc' => 'Затраты на покупку газа, тыс. руб',
            ],
            [
                'meta_object_id' => Str::Uuid()->toString(),
            ...
            [
                ...
                'desc' => 'Затраты на ремонт котельной, тыс. руб.',
            ],
            [
                'meta_object_id' => Str::Uuid()->toString(),
                'object' => 'equipment_operating_cost',
                'caption' => 'Затраты на эксплуатацию оборудования ХВО',
                'desc' => 'Затраты на эксплуатацию оборудования ХВО, тыс. руб.',
            ],
        ];
        ...
        foreach ($boiler_room_expenditures_attrs as &$attr) {
            ...
            $attr['name'] = 'meta_' . 'boiler_room_expenditure_' . $attr['object'];
